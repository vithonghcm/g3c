...
=======
        var fieldValue = typeof value === 'function' ? value() : value;

        (0, _utils.setByDot)(data, field, fieldValue);
...
=======
  return setField.apply(undefined, ['createdAt', function () {
    return new Date();
  }].concat(fieldNames));
>>>>>>> 529789d50613867eb4e9b77788dcf7a313297e4f
};
...
=======
  return setField.apply(undefined, ['updatedAt', function () {
    return new Date();
  }].concat(fieldNames));
>>>>>>> 529789d50613867eb4e9b77788dcf7a313297e4f
};
